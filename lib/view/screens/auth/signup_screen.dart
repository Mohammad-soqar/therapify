          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: AppInputDecoration.roundInputDecoration(
                  context: context, hintText: 'Phone'
                ),
              ),
              VSpace(16.h),
              ...
              TextFormField(
                ...
                validator: (v) => (v?.isEmpty ?? true) ? 'Enter category' : null,
                decoration: AppInputDecoration.roundInputDecoration(
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (v) => (v?.isEmpty ?? true) ? 'Enter fee' : null,
                      decoration: AppInputDecoration.roundInputDecoration(
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType.number,
                      validator: (v) => (v?.isEmpty ?? true) ? 'Enter net fee' : null,
                      decoration: AppInputDecoration.roundInputDecoration(
                ...
                Expanded(
                  child: AppButton(
                    title: _availDate == null 
                        ? "Pick Date" : _availDate!.toLocal().toIso8601String().split('T').first,
                    height: 44.h,
                    onPress: _pickDate,
                  ),
                ),
